<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="cursor-pointer">
      <img src="https://picsum.photos/300/300" class="rounded-full max-h-[60px]">
    </div>
    <div class="pl-3 w-full px-4">
      <div class="flex item-center justify-between pb-0 5">
        <button>
      ...
      <div class="mt-2.5 flex">
        <div
          ...
          <video ref="video" autoplay loop muted class="rounded-xl object-cover mx-auto h-full" src="/180386 (1080p).mp4" />
          ...
          <div class="absolute bottom-0 pl-2">
            <div class="pb-4 text-center">
              <button
                ...
                <Icon name="mdi:heart" size="25" color="#F02C56" />
              </button>
