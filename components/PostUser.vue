<template>
  <div @mouseenter="isHover(true)"
      @mouseleave="isHover(false)" class=" relative brightness-90 hover:brightness-[1.1] cursor-pointer">
    <div
      v-if="false"
    ...
    <div>
      <video ref="video" muted loop class="aspect-[3/4] object-cover rounded-md" src="/180386 (1080p).mp4" />
    </div>
    <div class="px-1">
